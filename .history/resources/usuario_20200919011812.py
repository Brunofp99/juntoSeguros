...
update.add_argument('login', type=str, required=True, help="Teh field 'login' cannot be left blank")
...
class UserUpdate(Resource):
    def put(self, id):
        ...
        if user_encontrado:
            ...
            return userr_encontrado.json()
        return {'message': 'this user id {} dont have a register'}
